...
package org.wso2.carbon.identity.debug.framework.async.operation.status.mgt.service;
...
import org.wso2.carbon.identity.debug.framework.async.operation.status.mgt.api.constants.ErrorMessage;
...
import org.wso2.carbon.identity.debug.framework.async.operation.status.mgt.api.models.UnitOperationResponseDTO;
import org.wso2.carbon.identity.debug.framework.async.operation.status.mgt.api.service.AsyncOperationStatusMgtService;
import org.wso2.carbon.identity.debug.framework.async.operation.status.mgt.internal.component.AsyncOperationStatusMgtDataHolder;
import org.wso2.carbon.identity.debug.framework.async.operation.status.mgt.internal.service.impl.AsyncOperationStatusMgtServiceImpl;
import org.wso2.carbon.identity.debug.framework.async.operation.status.mgt.util.TestUtils;
...
import static org.wso2.carbon.identity.debug.framework.async.operation.status.mgt.api.constants.OperationStatus.FAILED;
import static org.wso2.carbon.identity.debug.framework.async.operation.status.mgt.api.constants.OperationStatus.IN_PROGRESS;
import static org.wso2.carbon.identity.debug.framework.async.operation.status.mgt.api.constants.OperationStatus.SUCCESS;
import static org.wso2.carbon.identity.debug.framework.async.operation.status.mgt.constants.TestAsyncOperationConstants.CORR_ID_1;
import static org.wso2.carbon.identity.debug.framework.async.operation.status.mgt.constants.TestAsyncOperationConstants.CORR_ID_1_PREFIX;
import static org.wso2.carbon.identity.debug.framework.async.operation.status.mgt.constants.TestAsyncOperationConstants.CORR_ID_2;
import static org.wso2.carbon.identity.debug.framework.async.operation.status.mgt.constants.TestAsyncOperationConstants.CORR_ID_3;
import static org.wso2.carbon.identity.debug.framework.async.operation.status.mgt.constants.TestAsyncOperationConstants.CORR_ID_4;
import static org.wso2.carbon.identity.debug.framework.async.operation.status.mgt.constants.TestAsyncOperationConstants.INITIATOR_ID_1;
import static org.wso2.carbon.identity.debug.framework.async.operation.status.mgt.constants.TestAsyncOperationConstants.POLICY_SELECTIVE_SHARE;
import static org.wso2.carbon.identity.debug.framework.async.operation.status.mgt.constants.TestAsyncOperationConstants.POLICY_SHARE_WITH_ALL;
import static org.wso2.carbon.identity.debug.framework.async.operation.status.mgt.constants.TestAsyncOperationConstants.RESIDENT_ORG_ID_1;
import static org.wso2.carbon.identity.debug.framework.async.operation.status.mgt.constants.TestAsyncOperationConstants.RESIDENT_ORG_ID_2;
import static org.wso2.carbon.identity.debug.framework.async.operation.status.mgt.constants.TestAsyncOperationConstants.RESIDENT_ORG_ID_3;
import static org.wso2.carbon.identity.debug.framework.async.operation.status.mgt.constants.TestAsyncOperationConstants.RESIDENT_ORG_ID_4;
import static org.wso2.carbon.identity.debug.framework.async.operation.status.mgt.constants.TestAsyncOperationConstants.RESIDENT_ORG_NAME_2;
import static org.wso2.carbon.identity.debug.framework.async.operation.status.mgt.constants.TestAsyncOperationConstants.RESIDENT_ORG_NAME_3;
import static org.wso2.carbon.identity.debug.framework.async.operation.status.mgt.constants.TestAsyncOperationConstants.RESIDENT_ORG_NAME_4;
import static org.wso2.carbon.identity.debug.framework.async.operation.status.mgt.constants.TestAsyncOperationConstants.SUBJECT_ID_1;
import static org.wso2.carbon.identity.debug.framework.async.operation.status.mgt.constants.TestAsyncOperationConstants.SUBJECT_ID_1_PREFIX;
import static org.wso2.carbon.identity.debug.framework.async.operation.status.mgt.constants.TestAsyncOperationConstants.SUBJECT_ID_2;
import static org.wso2.carbon.identity.debug.framework.async.operation.status.mgt.constants.TestAsyncOperationConstants.SUBJECT_ID_3;
import static org.wso2.carbon.identity.debug.framework.async.operation.status.mgt.constants.TestAsyncOperationConstants.SUBJECT_ID_4;
import static org.wso2.carbon.identity.debug.framework.async.operation.status.mgt.constants.TestAsyncOperationConstants.SUBJECT_TYPE_APPLICATION;
import static org.wso2.carbon.identity.debug.framework.async.operation.status.mgt.constants.TestAsyncOperationConstants.SUBJECT_TYPE_USER;
import static org.wso2.carbon.identity.debug.framework.async.operation.status.mgt.constants.TestAsyncOperationConstants.TENANT_DOMAIN_1;
import static org.wso2.carbon.identity.debug.framework.async.operation.status.mgt.constants.TestAsyncOperationConstants.TYPE_APP_SHARE;
import static org.wso2.carbon.identity.debug.framework.async.operation.status.mgt.constants.TestAsyncOperationConstants.TYPE_USER_BULK_IMPORT;
import static org.wso2.carbon.identity.debug.framework.async.operation.status.mgt.constants.TestAsyncOperationConstants.TYPE_USER_SHARE;
